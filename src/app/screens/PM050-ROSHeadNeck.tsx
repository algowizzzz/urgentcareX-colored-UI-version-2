...
export default function ROSHeadNeck({ onContinue, onBack, initialData }: ROSHeadNeckProps) {
    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-8 pb-4 bg-white">
        ...
        <p className="text-base text-[#6B7280]">
          Select any head or neck symptoms you're currently experiencing.
        </p>
      </div>
