...
interface ROSEarsNoseThroatProps {
...
export default function ROSEarsNoseThroat({ onContinue, onBack, initialData }: ROSEarsNoseThroatProps) {
      ...
      <div className="px-8 pb-4 bg-white">
        ...
        <div className="mb-6">
          <p className="text-sm font-medium text-[#6B7280] mb-2">
            {QUESTIONNAIRE_NAME}: Step 4 of 8
          </p>
          <div className="w-full h-1 bg-[#E5E7EB] rounded-full overflow-hidden">
            <div className="h-full bg-[#1F2937] rounded-full" style={{ width: '50%' }}></div>
          </div>
        </div>
        ...
        <p className="text-base text-[#6B7280]">
          Select any ear, nose, or throat symptoms you're currently experiencing.
        </p>
      </div>
