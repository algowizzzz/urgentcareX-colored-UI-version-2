  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="bg-[#D97706] flex items-center px-4 py-4">
        ...
        <h2 className="text-lg font-semibold text-white ml-2">Appointment Details</h2>
      </div>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              ...
              <div className={`inline-flex px-3 py-1 ${
                appointment.status === 'confirmed' ? 'bg-[#D97706]' :
                appointment.status === 'pending' ? 'bg-[#D97706]' :
                appointment.status === 'cancelled' ? 'bg-[#EF4444]' :
                'bg-[#D97706]'
              }/10 rounded-full`}>
                <p className={`text-sm font-medium ${
                  appointment.status === 'confirmed' ? 'text-[#D97706]' :
                  appointment.status === 'pending' ? 'text-[#D97706]' :
