...
export default function ROSRespiratory({ onContinue, onBack, initialData }: ROSRespiratoryProps) {
      ...
      <div className="px-8 pb-4 bg-white">
        ...
        <div className="mb-6">
          <p className="text-sm font-medium text-[#6B7280] mb-2">
            {QUESTIONNAIRE_NAME}: Step 6 of 8
          </p>
          <div className="w-full h-1 bg-[#E5E7EB] rounded-full overflow-hidden">
            <div className="h-full bg-[#1F2937] rounded-full" style={{ width: '75%' }}></div>
          </div>
        </div>
        ...
        <p className="text-base text-[#6B7280] mb-6">
          Select any breathing or lung-related symptoms you're currently experiencing.
        </p>

        {/* Warning Notice */}
        <div className="bg-[#EF4444]/10 border-l-4 border-[#EF4444] rounded-xl p-4">
          <div className="flex items-start gap-2">
            <span className="text-lg">⚠️</span>
            <p className="text-sm text-[#1F2937]">
              <span className="font-semibold">If you're having severe difficulty breathing, call 911 immediately.</span>
            </p>
          </div>
        </div>
      </div>
